...
async def play_basket(client: Client, message: Message):
    ...
    if amount > user_balance:
        await message.reply("**Yeterli bakiyeniz yok. 😢             Görev yap bakiye kazan.     Botumuzu 1 guruba ekle     1.000.000 Kazan                  İLETİŞİM> @MAD1BOYbakiyeniz yok.** 😢")
        return
...
async def play_slot(client: Client, message: Message):
    ...
    win_chance = 0.50 # %45 kazanma şansı
